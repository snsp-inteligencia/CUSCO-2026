/* CUSCO 2026 Service Worker v1.4.0 */
const CACHE_NAME = "cusco-2026-v1-4-0";
...
const APP_SHELL = [
  ...
  BASE_PATH + "cusky_saludo.png?v=140",
  BASE_PATH + "cusky_revision.png?v=140",
  BASE_PATH + "cusky_exito.png?v=140",
